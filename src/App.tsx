...
const App: React.FC = () => {
  ...
  const [revenuRecherche, setRevenuRecherche] = useState<number>(300);
  const [dureePlacement, setDureePlacement] = useState<number>(10);
  ...
  const handleEmailSubmit = async (e: React.FormEvent) => {
    ...
    try {
        const response = await fetch('/.netlify/functions/send-simulation', {
            ...
            body: JSON.stringify({ email, data: simulationData, theme: 'Aider un proche' }),
        });
    ...
    <div className="bg-gradient-to-br from-slate-900 to-slate-700 p-4 sm:p-8 font-sans flex items-center justify-center min-h-screen">
      <div className="bg-slate-800/50 backdrop-blur-sm ring-1 ring-white/10 p-6 sm:p-10 rounded-2xl shadow-2xl w-full max-w-5xl mx-auto">
        ...
        <div className="text-center mb-10">
            ...
            <p className="text-slate-300 mt-2">Simulez l'épargne nécessaire pour verser une aide mensuelle à un parent ou un enfant.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 mb-12">
            ...
            <div className="lg:col-span-2 bg-slate-700/50 p-6 rounded-lg shadow-inner ring-1 ring-white/10">
                <h2 className="text-2xl font-semibold text-[#00FFD2] mb-6">Votre Projet</h2>
                <div className="space-y-6">
                <InputSlider
                    id="revenuRecherche"
                    label="Aide mensuelle à verser"
                    unit="€"
            ...
            <div className="lg:col-span-3 bg-slate-700/50 p-6 rounded-lg shadow-inner ring-1 ring-white/10 flex flex-col justify-start">
                <div className="text-center">
                    ...
                    <p className="text-gray-300 mb-6">Pour pouvoir verser une aide de <span className="font-bold text-white">{revenuRecherche.toLocaleString('fr-FR')} €/mois</span>, l'effort d'épargne suggéré est de :</p>
